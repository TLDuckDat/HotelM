...
const TRANSLATIONS = {
    en: {
        ...
        // ── Admin statistics ─────────────────────────────────────────────
        admin_manage_statistics: 'View Statistics',
        sidebar_statistics: 'Statistics',
        admin_stats_title: 'Revenue & KPI Statistics',
        admin_stats_sub: 'Track branch performance and revenue targets',
        admin_stats_select_period: 'Select Period:',
        admin_stats_total_rev: 'Total Revenue Achieved',
        admin_stats_overall_target: 'Overall Target',
        admin_stats_avg_achiev: 'Average Achievement',
        admin_stats_chart_title: 'Revenue vs Target by Branch',
        admin_stats_form_title: 'Set Branch KPI Target',
        admin_stats_label_branch: 'Branch',
        admin_stats_label_year: 'Target Year',
        admin_stats_label_month: 'Target Month',
        admin_stats_label_rev: 'Target Revenue (₫)',
        admin_stats_btn_save: 'Save Target',
        admin_stats_btn_recalc: 'Recalculate KPIs',
        admin_stats_table_title: 'Branch Performance Data',
        admin_stats_col_branch: 'Branch',
        admin_stats_col_rev: 'Revenue',
        admin_stats_col_target: 'Target',
        admin_stats_col_achiev: 'Achievement',
        admin_stats_col_occ: 'Occupancy',
        admin_stats_col_rating: 'Avg Rating',
        ...
        admin_rooms_add_branch: 'Add New Branch',
        admin_rooms_label_bname: 'Branch Name',
        admin_rooms_label_address: 'Address',
        admin_rooms_label_city: 'City',
        admin_rooms_label_email: 'Email',
        admin_rooms_btn_add_branch: 'Add Branch',
        admin_rooms_add_type: 'Add New Room Type',
        admin_rooms_label_tname: 'Type Name',
        admin_rooms_label_price: 'Base Price',
        admin_rooms_btn_add_type: 'Add Room Type',
        admin_rooms_label_rtype: 'Room Type',
        admin_rooms_label_rbranch: 'Branch',
        ...
        phone: "Phone Number",
        role: "Role",
        email_change_note: "Contact admin to change your email account",
        ...
        refunds_info_banner: "Refund requests are reviewed within 3–5 business days. Approved refunds will be returned via your original payment method.",
        refunds_no_data: "No refund request found",
        ...
        label_payment_booking: "Room & Price",
        payments_col_room: "Room",

        qr_scan_confirm: "Scan QR and confirm",
        qr_scan_desc: "Scan the QR below with your banking app, transfer the exact amount, then press confirm.",
        qr_bank: "Bank:",
        qr_account: "Account:",
        qr_amount: "Amount:",
        qr_note: "Transfer note:",
        qr_btn_paid: "I have paid",
        qr_btn_hide: "Hide QR",
    ...
    vi: {
        ...
        // ── Admin statistics ─────────────────────────────────────────────
        admin_manage_statistics: 'Xem thống kê',
        sidebar_statistics: 'Thống kê',
        admin_stats_title: 'Thống kê Doanh thu & KPI',
        admin_stats_sub: 'Theo dõi hiệu suất và chỉ tiêu doanh thu của chi nhánh',
        admin_stats_select_period: 'Chọn kỳ:',
        admin_stats_total_rev: 'Tổng doanh thu đạt được',
        admin_stats_overall_target: 'Tổng chỉ tiêu',
        admin_stats_avg_achiev: 'Hoàn thành trung bình',
        admin_stats_chart_title: 'Doanh thu vs Chỉ tiêu theo chi nhánh',
        admin_stats_form_title: 'Thiết lập KPI Chi nhánh',
        admin_stats_label_branch: 'Chi nhánh',
        admin_stats_label_year: 'Năm',
        admin_stats_label_month: 'Tháng',
        admin_stats_label_rev: 'Chỉ tiêu Doanh thu (₫)',
        admin_stats_btn_save: 'Lưu Chỉ tiêu',
        admin_stats_btn_recalc: 'Tính toán lại KPI',
        admin_stats_table_title: 'Dữ liệu Hiệu suất Chi nhánh',
        admin_stats_col_branch: 'Chi nhánh',
        admin_stats_col_rev: 'Doanh thu',
        admin_stats_col_target: 'Chỉ tiêu',
        admin_stats_col_achiev: 'Hoàn thành',
        admin_stats_col_occ: 'Tỷ lệ lấp đầy',
        admin_stats_col_rating: 'Đánh giá',
        ...
        admin_rooms_add_branch: 'Thêm Chi Nhánh Mới',
        admin_rooms_label_bname: 'Tên chi nhánh',
        admin_rooms_label_address: 'Địa chỉ',
        admin_rooms_label_city: 'Thành phố',
        admin_rooms_label_email: 'Email',
        admin_rooms_btn_add_branch: 'Thêm Chi Nhánh',
        admin_rooms_add_type: 'Thêm Loại Phòng Mới',
        admin_rooms_label_tname: 'Tên loại phòng',
        admin_rooms_label_price: 'Giá cơ bản',
        admin_rooms_btn_add_type: 'Thêm Loại Phòng',
        admin_rooms_label_rtype: 'Loại phòng',
        admin_rooms_label_rbranch: 'Chi nhánh',
        ...
        phone: "Số điện thoại",
        role: "Vai trò",
        email_change_note: "Liên hệ admin để đổi tài khoản email",
        ...
        payments_col_room: "Phòng",
        payments_col_amount: "Số tiền",
        payments_col_method: "Phương thức",
        payments_col_status: "Trạng thái",
        create_qr_payment: "Tạo Thanh Toán QR",
        btn_confirm_payment: "Xác nhận thanh toán",
        label_payment_booking: "Phòng & Giá",

        // ── Refund Requests Page ─────────────────────────────────────────────
        refunds_title: "Yêu cầu hoàn tiền",
        refunds_desc: "Gửi và theo dõi các yêu cầu hoàn tiền",
        refunds_info_banner: "Yêu cầu hoàn tiền sẽ được xem xét trong vòng 3–5 ngày làm việc. Số tiền được hoàn sẽ được trả lại qua phương thức thanh toán ban đầu của bạn.",
        refunds_no_data: "Không tìm thấy yêu cầu hoàn tiền nào",
